<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Layout.Master" AutoEventWireup="true" CodeBehind="Recursos.aspx.cs" Inherits="ControlaRecursos.Views.Recursos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphConteudo" runat="server">
    <asp:Panel ID="PanelButtons" runat="server" Height="133px" BorderColor="Silver" BorderWidth="2px" HorizontalAlign="Center">
        ...
        <asp:Button ID="btnPessoa" runat="server" CssClass="buttonCSS" Text="Pessoas" Width="120px" OnClick="btnPessoa_Click" />
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btnRecurso" runat="server" CssClass="buttonCSS" Text="Recursos" Width="120px" Enabled="False" />
        <br />
    </asp:Panel>
    ...
    <asp:Panel ID="PanelPesquisar" runat="server" CssClass="auto-style6" Height="130px" GroupingText="Pesquisar" HorizontalAlign="left">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="lblMsgErro" runat="server" ForeColor="Red" Text="*Preenchimento do campo pesquisar obrigatório" Visible="False" CssClass="labelMensagem" Width="56%"></asp:Label>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br />
        <br />
        &nbsp;&nbsp;
        <asp:Button ID="btnPesquisar" runat="server" CssClass="buttonCSS" OnClick="btnPesquisar_Click" Text="Pesquisar" Width="120px" UseSubmitBehavior="true" />
            &nbsp;
        <asp:Button ID="btnEditar" runat="server" CssClass="buttonCSS" Text="Editar" Width="120px" Enabled="False" OnClick="btnEditar_Click" />
        &nbsp;&nbsp;<asp:Button ID="btnExcluir" runat="server" CssClass="buttonCSS" OnClick="btnExcluir_Click" Text="Excluir" Width="120px" Enabled="False" />
...
&nbsp;
    ...
    <asp:Panel ID="PanelRecurso" runat="server" CssClass="auto-style18" GroupingText="Dados Recurso" Height="100%" Visible="False">
        <br />
        <asp:Label ID="lblRecursoId" runat="server" Text="Id Recurso :" Visible="False"></asp:Label>
        ...
        <asp:TextBox ID="txtRecurso" runat="server" CssClass="auto-style20" Width="462px"></asp:TextBox>
        <br />
        <br />
        &nbsp;&nbsp;&nbsp;
        <asp:Label ID="lblCodigo" runat="server" Text="Codigo :"></asp:Label>
        <asp:TextBox ID="txtCodigo" runat="server" CssClass="auto-style21"></asp:TextBox>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:CheckBox ID="chkRecursoAtivo" runat="server" Text="Ativo" />
        <br />
        <br />
                &nbsp;&nbsp;
        <asp:Button ID="btnSalvarNovo" runat="server" CssClass="buttonCSS" OnClick="btnSalvarRecurso_Click" Text="Salvar" Width="120px" Enabled="False" />
        &nbsp;
        ...
        &nbsp;
        <asp:Button ID="btnLimpa" runat="server" CssClass="buttonCSS" OnClick="btnLimpaSelec_Click" Text="Cancelar" Width="120px" />
        <br />
        <br />
    </asp:Panel>
</asp:Content>
